...
use App\Models\LineNoticeUserSetting;

/**
 * LineNoticeUserSettingRepository
 * 
 */
class LineNoticeUserSettingRepository implements LineNoticeUserSettingRepositoryInterface
{
    /**
     * LINE通知担当者設定情報を取得
     * 
    ...
    {
        return LineNoticeUserSetting::whereLineId($lineId)->get();
    }
    ...
    {
        return LineNoticeUserSetting::whereLineId($lineId)->delete();
    }
    ...
    public function inserts($lineId, $lineNoticeSttings)
    {
        ...
        return LineNoticeUserSetting::insert($datas);
    }
}